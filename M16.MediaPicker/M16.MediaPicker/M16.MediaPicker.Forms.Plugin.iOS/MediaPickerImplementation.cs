...
using System;
using Xamarin.Forms;
using M16.MediaPicker.Forms.Plugin.iOS;
...
namespace M16.MediaPicker.Forms.Plugin.iOS
{
    /// <summary>
    ...
    public class MediaPickerImplementation : IMediaPicker
    {
        ...
        public MediaPickerImplementation()
        {
            ...
            var available = new List<string>(availableCameraMedia);
            available.AddRange(availableLibraryMedia);
