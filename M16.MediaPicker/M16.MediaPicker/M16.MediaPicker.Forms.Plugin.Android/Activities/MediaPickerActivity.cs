namespace M16.MediaPicker.Forms.Plugin.Droid.Activities
{
    using System;
    using System.IO;
    ...
    using M16.MediaPicker.Forms.Plugin.Abstractions.Helpers;
        ...
        protected override void OnActivityResult(int requestCode, Result resultCode, Intent data)
        {
            ...
            if (_tasked)
            {
                var future = resultCode == Result.Canceled
                    ? TaskHelpers.TaskFromResult(new MediaPickedEventArgs(requestCode, true))
            ...
            bool isPhoto, ref Uri path, Uri data)
        {
            ...
            if (action != Intent.ActionPick)
            {
                ...
                if (data != null && data.Path != originalPath)
                {
                    ...
                    pathFuture = TaskHelpers.TaskFromResult(new Tuple<string, bool>(path.Path, false));
            }
            else if (data != null)
            {
                originalPath = data.ToString();
            ...
            {
                pathFuture = TaskHelpers.TaskFromResult<Tuple<string, bool>>(null);
            }
            ...
            return pathFuture.ContinueWith(t =>
            {
                ...
                return new MediaPickedEventArgs(requestCode, new Exception(originalPath));
            });
        }
